...
Difference from lstm_principle1.py (hybrid):
  ...
  * This script produces the *_alt checkpoints for Principle 1 used in
    eval_baseline_vs_p1.py under "encoded" mode.
"""
import os
import numpy as np
import torch
...
# Depending on environment, you might need to adjust this import (e.g. vae_p1 vs vae_principle1)
from vae_principle1 import VAE_P1, encode_fn
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if val_mean < best - 1e-6:
            ...
            torch.save(model.state_dict(),
                       os.path.join(SAVE_DIR, "lstm_p1_alt_best.pth"))
