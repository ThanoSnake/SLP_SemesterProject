"""
extension_main_shield_emergency_relaxed.py — Extension 4: a looser ADDITIVE vertical shield.
...
VERT_FUEL_W = 0.05                # lower fuel penalty so it does not block emergency braking
EMERGENCY_Y_MAX = 1.10            # looser: give main more time before the ground
EMERGENCY_VY_MAX = -0.25          # looser: catch the downward trend earlier
